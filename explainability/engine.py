...
class ExplainabilityEngine:
    ...
    def explain(self, input_frame: pd.DataFrame) -> dict[str, Any]:
        ...
        return {
            ...
            "summary": self._readable_summary(local_scores),
        }
    ...
    def _humanize_feature_name(feature: str) -> str:
        value = feature.replace("num__", "").replace("cat__", "").replace("_", " ")
        return " ".join(value.split()).title()

    def _readable_summary(self, shap_local: list[dict[str, Any]]) -> str:
        top_shap = [
        ...
        return "\n".join(
            [
                "This explanation highlights the strongest drivers behind the model decision.",
                "",
                "Top SHAP drivers:",
